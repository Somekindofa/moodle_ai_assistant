...
class RAG:
    """RAG (Retrieval Augmented Generation) class for document-based question answering.
    
    This class combines vector-based document retrieval with large language models to provide
    contextually informed responses. It uses ChromaDB for document storage and retrieval,
    HuggingFace embeddings for semantic search, and configurable LLMs for generation.
    Attributes:
        collection_name (str): Name of the ChromaDB collection for document storage.
            Defaults to "example_collection".
        persist_directory (str): Directory path where ChromaDB data will be persisted.
            Defaults to "./chroma_langchain_db".
        prompt: Optional prompt template for formatting queries to the LLM.
            If None, generation methods will raise ValueError.
    """
